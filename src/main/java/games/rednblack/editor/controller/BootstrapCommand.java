...
public class BootstrapCommand extends SimpleCommand {
    ...
    public void execute(INotification notification) {
        ...
        facade.registerCommand(MsgAPI.ACTION_ACTIONS_SPRITER_ANIMATION_DATA, ActionsSpriterDataCommand::new);
        ...
        facade.registerCommand(MsgAPI.ACTION_SPRITER_EDIT_ANIMATION_RESOURCE, SpriterEditAnimationCommand::new);
