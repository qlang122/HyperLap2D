...
public class UIAnimationsTabMediator extends UIResourcesTabMediator<UIAnimationsTab> {
    ...
    private void createAnimationResources(Set<String> strings, Class<? extends BoxItemResource> resourceClass, BiFunction<ResourcePayloadObject, Vector2, Boolean> factoryFunction, String searchText) {
